...
function Feedback() {
    ...
    return (
      <div className="w-full min-h-screen bg-green-400 flex items-center justify-center p-4">
        ...
        {/* Display Feedback */}
        <div className="mt-6">
          <h3 className="text-xl font-semibold mb-2 text-center">Recent Feedback</h3>
